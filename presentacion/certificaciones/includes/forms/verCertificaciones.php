...
<div class="centered">
    ...
    <script type="text/javascript">
        ...
        { 
            ...
            mtype: "POST",
            datatype: "json",
            colNames:['IdCertificacion','Fecha','Nombre','IdProfesionales','IdHospital','FechaInicio','FechaFinal','',''],
            colModel:[ 
                {name:'IdCertificacion', index:'cer.IdCertificacion',width:'0%',align:"left",fixed:true,editable:false},
                {name:'Fecha', index:'cer.Fecha',width:'100%',align:"left",fixed:true,editable:true},
                {name:'Nombre', index:'pro.`Apellido y Nombre`',width:'100%',align:"left",fixed:true,editable:true},
                {name:'IdProfesionales', index:'cer.IdProfesionales',width:'0%',align:"left",fixed:true,editable:true},
                {name:'IdHospital', index:'cer.IdHospital',width:'0%',align:"left",fixed:true,editable:true},
